...
admin.site.register(core.Author, AuthorAdmin)
...
admin.site.register(core.Status, StatusAdmin)
...
admin.site.register(core.Story, StoryAdmin)


class PageAdmin(admin.ModelAdmin):
    prepopulated_fields = {'slug': ('title',)}

admin.site.register(core.Page, PageAdmin)
