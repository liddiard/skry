...
class PhotoRequestComment(InternalComment):
    request = models.ForeignKey('art_request.PhotoRequest')
...
class GraphicRequestComment(InternalComment):
    request = models.ForeignKey('art_request.GraphicRequest')
...
class IllustrationRequestComment(InternalComment):
    request = models.ForeignKey('art_request.IllustrationRequest')
