...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.position'
        db.add_column(u'prime_article', 'position',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.position'
        db.delete_column(u'prime_article', 'position')
    ...
    models = {
        ...
        u'prime.article': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'issue': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['prime.Issue']"}),
